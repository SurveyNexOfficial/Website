...
export default function JobsPage() {
	...
	return (
		<section className="relative min-h-screen py-10 w-full bg-white">
					...
					<div className="grid grid-cols-1 md:grid-cols-3 gap-4">
						...
						<div className="relative">
							...
							<input
								...
								className="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-sm focus:ring-2 focus:ring-gray-200 focus:border-gray-400 outline-none"
							/>
						</div>
						...
						<div className="relative">
							...
							<select
								...
								className="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-sm focus:ring-2 focus:ring-gray-200 focus:border-gray-400 outline-none appearance-none bg-white">
						...
						<div>
							<select
								...
								className="w-full px-4 py-2 border border-gray-300 rounded-sm focus:ring-2 focus:ring-gray-200 focus:border-gray-400 outline-none appearance-none bg-white">
								{statuses.map((status) => (
