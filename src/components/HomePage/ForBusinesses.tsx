				...
				<div className="grid lg:grid-cols-2 gap-16 items-center">
					<div className="bg-gray-50 rounded-3xl p-8 shadow-2xl">
						...
						<div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6">
							...
							<div className="bg-white rounded-xl p-4 shadow-lg">
								<div className="text-2xl font-bold text-black mb-1">2.3min</div>
								<div className="text-sm text-gray-600">Avg. Time</div>
							</div>
							<div className="bg-white rounded-xl p-4 shadow-lg">
								<div className="text-2xl font-bold text-black mb-1">98.7%</div>
					...
					<div>
						...
						<div className="space-y-8">
							{businessBenefits.map((benefit, index) => (
								<div
									key={index}
									className="flex items-start space-x-6 bg-gray-50 rounded-2xl p-6 shadow-lg">
						...
						<div className="mt-10 flex flex-col sm:flex-row gap-4">
							...
							<button className="px-10 py-4 border-2 border-black text-black text-lg font-bold rounded-2xl hover:bg-black hover:text-white transition-all">
								Schedule Demo
							</button>
						</div>
					</div>
